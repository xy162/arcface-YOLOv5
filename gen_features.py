            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    if not os.path.exists(out_dir):
                        os.makedirs(out_dir)
                    flie_name = os.path.join(out_dir, os.path.split(p)[1].split("_")[0])
...
if __name__ == '__main__':
    ...
    parser.add_argument('--yolo_weight', type=str, default='weights/best.pt', help='model.pt path(s)')
    parser.add_argument('--arcface_weight', type=str, default=r'weights/arcface.pth',
                        help='arcface.pth path')
    parser.add_argument('--source', type=str, default='./photo/wy/wy_mask.jpg', help='source')  # file/folder, 0 for webcam
